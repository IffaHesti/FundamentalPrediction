...
ml_algorithms = {
    # "DT": dihapus untuk mengurangi kompleksitas dan waktu; DT sering overfit pada data ini
    "LR": {
...
number_of_features = min(max_features, (nColumns - len(index_columns+dl_columns)))  # batasi fitur untuk performa; mencegah overfitting pada dataset kecil
